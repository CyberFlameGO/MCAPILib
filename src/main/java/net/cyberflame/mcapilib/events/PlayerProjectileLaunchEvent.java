 ...
 */
public class PlayerProjectileLaunchEvent extends PlayerEvent implements Cancellable
{
    ...
    public PlayerProjectileLaunchEvent(@NotNull Player shooter, @NotNull ItemStack itemStack,
